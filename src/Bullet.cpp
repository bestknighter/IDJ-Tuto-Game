...
Bullet::Bullet (Vec2 pos, float angle, float speed, float maxDistance, std::string sprite, bool targetsPlayer, float damage, unsigned int frameCount, float frameTime) : sp(sprite, frameCount, frameTime) {
